...
GPIO.setup(PULLPUSHSOLENOID_PIN_SIG , GPIO.IN , pull_up_down = GPIO.PUD_DOWN)
...
while True:
    input_state = GPIO.input(PULLPUSHSOLENOID_PIN_SIG)  
    if (input_state == False):
        aldOpen = isOpen
        isOpen = GPIO.input(MAGNETICDOORSWITCH3V3_PIN_SIG and PUSHBUTTON_PIN)
